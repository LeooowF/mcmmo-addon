...
public class ItemBuilder {
    ...
    private ItemBuilder(ItemStack itemStack, Consumer<InventoryClickEvent> inventoryClickEventConsumer, Boolean editable, Boolean cancelled) {
    ...
    public ItemBuilder lore(Boolean keepLore, String... lore) {
        List<String> finalLore = Arrays.asList(lore);

        finalLore.replaceAll(ColorUtils::colored);

        return this.lore(keepLore, finalLore);
    }

    public ItemBuilder lore(Boolean keepLore, List<String> lore) {
        ItemMeta itemMeta = this.meta();

        lore.replaceAll(ColorUtils::colored);
    ...
    public ItemBuilder editable(Boolean editable) {
        this.editable = editable;

        return this;
    }

    public ItemBuilder cancelled(Boolean cancelled) {
        this.cancelled = cancelled;
    ...
    public ItemBuilder onClick(Consumer<InventoryClickEvent> inventoryClickEventConsumer) {
        this.inventoryClickEventConsumer = inventoryClickEventConsumer;
